...
func NewRuntime(syslog *zap.SugaredLogger, buildID string, runtimeID string, stream event.Stream, opts *executorv1.DockerOpts, client *client.Client) (*Runtime, error) {
